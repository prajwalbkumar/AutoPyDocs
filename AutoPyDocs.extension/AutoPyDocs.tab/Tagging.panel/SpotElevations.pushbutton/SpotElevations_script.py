...
try:
    ...
    for view in selected_views:
        ...
        if view_type == ViewType.Section:
            ...
            total_elements += len(filtered_ai_floor_finishes)
            total_elements += len(filtered_ai_ceiling_finishes)
            total_elements += len(filtered_pt_floors)
            total_elements += len(filtered_st_floors)
